...
assert.match(app, /experienceMode = "explore"/);
assert.match(app, /renderFocusPreview/);
assert.match(app, /openFullResults/);
assert.match(app, /updateCategoryButtonsState/);
assert.match(app, /transitionPlaceMarkers/);
assert.doesNotMatch(app, /pointer: coarse/);
...
assert.match(index, /id="categoryFocus"/);
assert.match(index, /id="focusPreview"/);
assert.match(index, /id="focusShowAll"/);
