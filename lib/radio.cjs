  ...
  try {
    const response = await fetchImpl(url, {
      ...
      headers: {
        ...
        "User-Agent": "Yakinim/3.1.2 (+https://yakinim.vercel.app)",
      },
    });
...
module.exports = { RADIO_SERVERS, RADIO_SCOPES, buildStationParams, cleanProviderText, normalizeStation, uniqueStations, queryRadio, countStationClick };
